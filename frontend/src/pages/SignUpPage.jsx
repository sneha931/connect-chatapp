...
function SignUpPage() {
  ...
  const validateform=()=>{
    ...
    if(formData.password.length < 6) return toast.error("password should have 6 characters");
          ...
          <form onSubmit={handlesubmit} className='space-y-6'>
            <div className='form-control'>
              ...
              <div className='relative'>
                <div className='absolute inset-y-0 left-0 pl-3 flex items-center pointer-evenets-none'>
